...
namespace MotorAsinBasketRobot.DataAccess.Concrete.EntityFramework.Context
{
    ...
    {
        public static string ConnString = "Data Source=ONURUMUTLUOGLU;Initial Catalog=MotorAsinBasketRobotProject;Integrated Security=True;Connect Timeout=30;Encrypt=False;Trust Server Certificate=False;Application Intent=ReadWrite;Multi Subnet Failover=False";
